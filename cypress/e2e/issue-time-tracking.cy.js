describe("Issue time tracking", () => {
  ...
  it("Test time estimation and logging functionality: add, edit and clear value", () => {
    ...
    cy.get('[data-testid="modal:issue-create"]').within(() => {
      cy.get(".ql-editor").type("TEST16_DESCRIPTION");
      cy.get(".ql-editor").should("have.text", "TEST16_DESCRIPTION");

      cy.get('input[name="title"]').type("TEST16_TITLE");
      cy.get('input[name="title"]').should("have.value", "TEST16_TITLE");
    ...
    cy.contains("TEST16_TITLE").click().wait(40000);
